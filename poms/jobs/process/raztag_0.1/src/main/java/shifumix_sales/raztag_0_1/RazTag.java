...
public class RazTag implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(RazTag.this, new Object[] { e,
	...
	public void tXMLMap_2_onSubJobError(Exception exception,
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SHIFUMIX_SALES_RazTag.length) {
					if (length < 1024
							&& commonByteArray_SHIFUMIX_SALES_RazTag.length == 0) {
				...
				strReturn = new String(commonByteArray_SHIFUMIX_SALES_RazTag,
	...
	public void tXMLMap_2Process(final java.util.Map<String, Object> globalMap)
			throws TalendException {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (out != null) {
					...
					try {
						...
						features_tRESTClient_2
								.add(new org.apache.cxf.feature.LoggingFeature());

						factoryBean_tRESTClient_2
								.setFeatures(features_tRESTClient_2);
						...
						if (use_auth_tRESTClient_2
							...
							org.apache.cxf.ws.security.trust.STSClient stsClient = org.talend.esb.security.saml.STSClientUtils
									.createSTSClient(
											factoryBean_tRESTClient_2.getBus(),
											"username",
											decryptedPassword_tRESTClient_2);

							org.talend.esb.security.saml.SAMLRESTUtils
									.configureClient(factoryBean_tRESTClient_2,
											stsClient);
						}
						...
						// set request path
						webClient_tRESTClient_2
								.path("dolibarr/api/index.php/projects");
						...
						tlsClientParameters_tRESTClient_2
						...
						webClient_tRESTClient_2.header("DOLAPIKEY",
								"j4r06PiJhT9j320d9ZVR5FZf2OcfOwXf");
						...
						if (use_auth_tRESTClient_2
							...
							webClient_tRESTClient_2
									.header("Authorization",
											"Bearer "
													+ "DOLAPIKEY: j4r06PiJhT9j320d9ZVR5FZf2OcfOwXf");
						}
							...
							try {
								if (!inOSGi) {
									...
									bearerHeader_tRESTClient_2 = org.talend.esb.security.oidc.OidcClientUtils
											.oidcClientBearer(
													username_tRESTClient_2,
													password_tRESTClient_2,
						...
						try {
							...
							responseDoc_tRESTClient_2 = webClient_tRESTClient_2
									.invoke("DELETE", requestBody_tRESTClient_2);
							...
							globalMap
									.put("tRESTClient_2_HEADERS",
											ex_tRESTClient_2.getResponse()
													.getHeaders());
						...
						throw new TalendException(e_tRESTClient_2,
								currentComponent, globalMap);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = RazTag.class.getClassLoader()
					.getResourceAsStream(
							"shifumix_sales/raztag_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = RazTag.class.getClassLoader().getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : RazTag");
		}
...
/************************************************************************************************
 * 48107 characters generated by Talend Open Studio for Data Integration on the
 * 22 juillet 2019 09:47:07 CEST
 ************************************************************************************************/
